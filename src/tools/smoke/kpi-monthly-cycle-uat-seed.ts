...
export function buildKpiMonthlyCycleUatSeedPlan(params: {
  ...
  add("responsibility_assignments", "support.talent-group-manager-responsibility", {
    _id: stable("responsibility:talent-group-manager"),
    ...
    status: "ACTIVE",
    isPrimary: true,
    effectiveAt: supportAt,
    expiresAt: null,
    revokedAt: null,
    reason: "UAT demo manager responsibility",
    createdAt: supportAt,
