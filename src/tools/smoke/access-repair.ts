...
function helpText(): string {
  return [
    ...
    "",
    "Dry run:",
    "  npm run access:repair -- --env-file .env.dev --roles TALENT_GROUP_MANAGER,PRODUCTION_OPS,HR_OPERATIONS --dry-run",
    "",
    "Write mode:",
    "  npm run access:repair -- --env-file .env.dev --roles TALENT_GROUP_MANAGER --user-id <user-id> --confirm-access-repair",
