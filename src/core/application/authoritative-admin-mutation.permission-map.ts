...
> = Object.freeze({
  ...
  "user.actor-kind.update": Permission.USER_ACTOR_KIND_UPDATE,
  ...
  "kpi.allocation-draft.upsert": Permission.KPI_ENTER_ACTUAL,
  "kpi.allocation.submit": Permission.KPI_ENTER_ACTUAL,
  "kpi.allocation.approve": Permission.KPI_MANAGE_ALLOCATION,
  "kpi.allocation.reject": Permission.KPI_MANAGE_ALLOCATION,
