...
export const PermissionContracts: PermissionContractRegistry = Object.freeze({
  ...
  [Permission.ROLE_ASSIGNMENT_REVIEW]: {
    code: Permission.ROLE_ASSIGNMENT_REVIEW,
    context: "ADMIN",
    resource: "ROLE_ASSIGNMENT",
    auditAction: "role.assignment.review",
    riskLevel: "CRITICAL",
  },
  [Permission.ROLE_ASSIGNMENT_GRACE_APPROVE]: {
    code: Permission.ROLE_ASSIGNMENT_GRACE_APPROVE,
    context: "ADMIN",
    resource: "ROLE_ASSIGNMENT",
    auditAction: "role.assignment.grace.approve",
    riskLevel: "CRITICAL",
  },
  [Permission.ROLE_ASSIGNMENT_RENEW]: {
    code: Permission.ROLE_ASSIGNMENT_RENEW,
    context: "ADMIN",
    resource: "ROLE_ASSIGNMENT",
    auditAction: "role.assignment.renew",
    riskLevel: "CRITICAL",
  },
  [Permission.ROLE_ASSIGNMENT_REPLACE]: {
    code: Permission.ROLE_ASSIGNMENT_REPLACE,
    context: "ADMIN",
    resource: "ROLE_ASSIGNMENT",
    auditAction: "role.assignment.replace",
    riskLevel: "CRITICAL",
  },
  [Permission.OWNER_GOVERNANCE_VIEW]: {
    code: Permission.OWNER_GOVERNANCE_VIEW,
    context: "ADMIN",
    resource: "OWNER_GOVERNANCE",
    auditAction: "owner.governance.view",
    riskLevel: "HIGH",
  },
  [Permission.OWNER_SUCCESSION_MANAGE]: {
    code: Permission.OWNER_SUCCESSION_MANAGE,
    context: "ADMIN",
    resource: "OWNER_GOVERNANCE",
    auditAction: "owner.succession.manage",
    riskLevel: "CRITICAL",
  },
  [Permission.BREAK_GLASS_REQUEST]: {
    code: Permission.BREAK_GLASS_REQUEST,
    context: "ADMIN",
    resource: "BREAK_GLASS",
    auditAction: "break-glass.request",
    riskLevel: "CRITICAL",
  },
  [Permission.BREAK_GLASS_ACTIVATE]: {
    code: Permission.BREAK_GLASS_ACTIVATE,
    context: "ADMIN",
    resource: "BREAK_GLASS",
    auditAction: "break-glass.activate",
    riskLevel: "CRITICAL",
  },
  [Permission.BREAK_GLASS_END]: {
    code: Permission.BREAK_GLASS_END,
    context: "ADMIN",
    resource: "BREAK_GLASS",
    auditAction: "break-glass.end",
    riskLevel: "CRITICAL",
  },
  [Permission.BREAK_GLASS_APPROVE]: {
    code: Permission.BREAK_GLASS_APPROVE,
    context: "ADMIN",
    resource: "BREAK_GLASS",
    auditAction: "break-glass.approve",
    riskLevel: "CRITICAL",
  },
  [Permission.BREAK_GLASS_REVIEW]: {
    code: Permission.BREAK_GLASS_REVIEW,
    context: "ADMIN",
    resource: "BREAK_GLASS",
    auditAction: "break-glass.review",
    riskLevel: "CRITICAL",
  },
