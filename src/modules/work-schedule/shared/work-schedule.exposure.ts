...
export const WorkScheduleAdminListExposure = Object.freeze({
      ...
      ExposurePolicy.expose(
        {
          ...
          sourceRosterTargetType: input.sourceRosterTargetType,
          sourceRosterTargetId: input.sourceRosterTargetId,
          sourceRosterTargetMode: input.sourceRosterTargetMode,
          sourceRosterLocalDate: input.sourceRosterLocalDate,
          sourceRosterSlotKey: input.sourceRosterSlotKey,
  ...
  exposeMany(items: readonly WorkShiftListItemView[]): readonly PlainObject[] {
    return items.map((item) => this.expose(item));
  },
});

export const WorkScheduleAdminBySubjectListExposure = Object.freeze({
  expose(input: WorkShiftBySubjectListItemView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          id: input.id,
...
export const WorkScheduleAdminByResourceListExposure = Object.freeze({
  expose(input: WorkShiftByResourceListItemView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          id: input.id,
...
export const WorkScheduleAdminDetailExposure = Object.freeze({
      ...
      ExposurePolicy.expose(
        {
          ...
          sourceExceptionId: input.sourceExceptionId,
          sourceGenerationRunId: input.sourceGenerationRunId,
          sourceRosterMonth: input.sourceRosterMonth,
          sourceDepartmentOrgUnitId: input.sourceDepartmentOrgUnitId,
          sourceDepartmentOrgUnitRef: input.sourceDepartmentOrgUnitRef,
          sourceRosterTargetType: input.sourceRosterTargetType,
          sourceRosterTargetId: input.sourceRosterTargetId,
          sourceRosterTargetMode: input.sourceRosterTargetMode,
          sourceMemberIdentityType: input.sourceMemberIdentityType,
          sourceRosterLocalDate: input.sourceRosterLocalDate,
          sourceRosterSlotKey: input.sourceRosterSlotKey,
          createdAt: input.createdAt,
...
export const WorkScheduleAdminMutationExposure = Object.freeze({
  expose(input: WorkShiftMutationView): PlainObject {
    return WorkScheduleAdminDetailExposure.expose(input);
  },
});

export const WorkScheduleRequestAdminExposure = Object.freeze({
  expose(
    input: WorkScheduleRequestView | WorkScheduleRequestListItemView,
  ): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          ...
          targetEmploymentProfileId: input.targetEmploymentProfileId,
          targetEmploymentProfileRef: input.targetEmploymentProfileRef ?? null,
          targetWorkShiftId: input.targetWorkShiftId,
          targetWorkShiftRef: input.targetWorkShiftRef ?? null,
          requestedByUserId: input.requestedByUserId,
          requestedByEmploymentProfileId: input.requestedByEmploymentProfileId,
          reason: input.reason,
          proposedStartAt: input.proposedStartAt,
          proposedEndAt: input.proposedEndAt,
          proposedTitle: input.proposedTitle,
          proposedStudioResourceIds: [...input.proposedStudioResourceIds],
          proposedDescription: input.proposedDescription,
          proposedExternalRef: input.proposedExternalRef,
          ...
          appliedWorkShiftRef: input.appliedWorkShiftRef ?? null,
          createdAt: input.createdAt,
          updatedAt: input.updatedAt,
        },
...
export const WorkScheduleRequestBatchAdminExposure = Object.freeze({
  exposeListItem(
    input: WorkScheduleRequestBatchListItemView | WorkScheduleRequestBatchView,
  ): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
      ...
      ExposurePolicy.expose(
        {
          ...
          memberEmploymentProfileRef: input.memberEmploymentProfileRef ?? null,
      ...
      ExposurePolicy.expose(
        {
          ...
          createdAt: input.createdAt,
          updatedAt: input.updatedAt,
          lines: input.lines.map((line) => this.exposeLine(line)),
        },
...
export const WorkPatternAdminExposure = Object.freeze({
  expose(
    input: WorkPatternView | WorkPatternListItemView | WorkPatternMutationView,
  ): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
...
export const HolidayCalendarEntryAdminExposure = Object.freeze({
  expose(input: HolidayCalendarEntryRecord): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          holidayCalendarEntryId: input.holidayCalendarEntryId,
          date: input.date,
...
export const HolidayCalendarAdminExposure = Object.freeze({
  expose(
    input:
      | HolidayCalendarView
      | HolidayCalendarListItemView
      ...
      ExposurePolicy.expose(
        {
          ...
          timezone: input.timezone,
          status: input.status,
          entries: HolidayCalendarEntryAdminExposure.exposeMany(input.entries),
          description: input.description,
          externalRef: input.externalRef,
          activatedAt: input.activatedAt,
          archivedAt: input.archivedAt,
...
export const RosterExceptionAdminExposure = Object.freeze({
  expose(input: RosterExceptionRecord): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          rosterExceptionId: input.rosterExceptionId,
          monthlyRosterId: input.monthlyRosterId,
          exceptionType: input.exceptionType,
          exceptionDate: input.exceptionDate,
          subjectEmploymentProfileId: input.subjectEmploymentProfileId,
          subjectEmploymentProfileRef: input.subjectEmploymentProfileRef,
          status: input.status,
          title: input.title,
          startLocalTime: input.startLocalTime,
          endLocalTime: input.endLocalTime,
          ...
          sourceAvailabilityBatchId: input.sourceAvailabilityBatchId ?? null,
          sourceAvailabilityLineId: input.sourceAvailabilityLineId ?? null,
          sourceAvailabilityType: input.sourceAvailabilityType ?? null,
          sourceAvailabilityTaxonomyCode:
            input.sourceAvailabilityTaxonomyCode ?? null,
          sourceAppliedAt: input.sourceAppliedAt ?? null,
          sourceApplyNote: input.sourceApplyNote ?? null,
          description: input.description,
          externalRef: input.externalRef,
          removedAt: input.removedAt,
          createdAt: input.createdAt,
  ...
  exposeMany(items: readonly RosterExceptionRecord[]): readonly PlainObject[] {
    return items.map((item) => this.expose(item));
  },
});

export const MonthlyRosterAdminExposure = Object.freeze({
  exposeListItem(input: MonthlyRosterListItemView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          monthlyRosterId: input.monthlyRosterId,
          ...
          timezone: input.timezone,
          targetSubjectKind: input.targetSubjectKind,
          targetOrgUnitMode: input.targetOrgUnitMode,
          ...
          targetTalentGroupRef: input.targetTalentGroupRef,
          targetRef: input.targetRef,
          departmentOrgUnitId: input.departmentOrgUnitId,
          departmentOrgUnitRef: input.departmentOrgUnitRef,
          workPatternId: input.workPatternId,
          workPatternRef: input.workPatternRef,
          holidayCalendarId: input.holidayCalendarId,
          holidayCalendarRef: input.holidayCalendarRef,
          status: input.status,
  ...
  exposeDetail(
    input: MonthlyRosterView | MonthlyRosterMutationView,
  ): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          ...
          exceptions: RosterExceptionAdminExposure.exposeMany(input.exceptions),
        },
...
export const MonthlyRosterPreviewAdminExposure = Object.freeze({
  ...
  exposeConflict(input: MonthlyRosterPreviewConflictView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          conflictKind: input.conflictKind,
          workShiftId: input.workShiftId,
          relatedPreviewRowId: input.relatedPreviewRowId,
          shiftCode: input.shiftCode,
          title: input.title,
          status: input.status,
          shiftStartAt: input.shiftStartAt,
      ...
      ExposurePolicy.expose(
        {
          ...
          linkedEmploymentProfileId: input.linkedEmploymentProfileId,
          linkedEmploymentProfileRef: input.linkedEmploymentProfileRef,
  ...
  exposeRow(input: MonthlyRosterPreviewRowView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
  ...
  exposeSummary(input: MonthlyRosterPreviewSummaryView): PlainObject {
    return toPlainObject(
      ExposurePolicy.expose(
        {
          totalEligibleProfiles: input.totalEligibleProfiles,
          includedMemberCount: input.includedMemberCount,
          excludedMemberCount: input.excludedMemberCount,
          totalStandardCandidateShifts: input.totalStandardCandidateShifts,
          totalHolidaySuppressions: input.totalHolidaySuppressions,
          totalWorkingToOff: input.totalWorkingToOff,
          totalChangeTime: input.totalChangeTime,
          totalAddSpecialShift: input.totalAddSpecialShift,
          totalCandidateShiftsAfterExceptions:
      ...
      ExposurePolicy.expose(
        {
          ...
          draftVersion: input.draftVersion,
          currentPreviewHash: input.currentPreviewHash,
          computedPreviewHash: input.computedPreviewHash,
          eligibleProfiles: input.eligibleProfiles.map((profile) =>
            this.exposeEligibleProfile(profile),
          ),
          excludedMembers: input.excludedMembers.map((member) =>
            this.exposeExcludedMember(member),
          ),
          rows: input.rows.map((row) => this.exposeRow(row)),
