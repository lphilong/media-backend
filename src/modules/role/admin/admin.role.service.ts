...
export class RoleAdminService {
  ...
  async assignRoleToUser(
    _actor: Actor,
    _command: AssignRoleToUserCommand,
  ): Promise<RoleAssignmentMutationResult> {
    throw new RoleValidationError(
      "ROLE_ASSIGN_TO_USER is superseded by POST /admin/access-assignments/preview and POST /admin/access-assignments/apply",
    );
  }

  async revokeRoleFromUser(
    _actor: Actor,
    _command: RevokeRoleFromUserCommand,
  ): Promise<RoleAssignmentMutationResult> {
    throw new RoleValidationError(
