    ...
    },
    {
      ...
      scopePlan: Object.freeze([
        ...
        scopePlan(
          ...
          ["direct-reports", "talent-group"],
          "REQUIRES_FUTURE_SCOPE",
          "Talent, event, and KPI object scoping require later assignment-scope policy.",
        ),
      ]),
      warnings: Object.freeze([
    ...
    },
    {
      ...
      scopePlan: Object.freeze([
        scopePlan(
          ...
          ["event", "studio", "department"],
          "REQUIRES_FUTURE_SCOPE",
          "Event and studio resource scoping is preview-only and may be global-only in current runtime routes.",
        ),
        scopePlan(
          "Work Schedule",
          ["department"],
      ...
      warnings: Object.freeze([
        "Event and studio scope is not materialized by this batch.",
