...
const KPI_ACTUAL_CORRECTION_FIELDS = [
  ...
  "replacementEntryVersion",
  "replacementLifecycleStatus",
  "requiresReview",
  "reason",
  "correctedAt",
  "createdAt",
...
export const KpiOrgUnitAllocationExposure = Object.freeze({
  ...
  exposeMany(
    items: readonly KpiOrgUnitAllocationItem[],
      ...
      ExposurePolicy.expose(
        {
          ...
          targetMetrics: input.targetMetrics.map((metric) => ({
            ...
            policyVersion: metric.policyVersion,
          })),
